...
export default function Navbar() {
  ...
  return (
    <motion.div className="fixed bottom-0 flex w-full pb-10 z-50"
      ...
      <nav className="w-full md:w-md mx-auto px-6 bg-gray-950/80 bg-opacity-50 backdrop-blur-sm p-4 outline-1 outline-gray-700 rounded-full shadow-lg shadow-cyan-500/20 overflow-hidden">
