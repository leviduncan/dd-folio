  ...
  return (
    <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
      {linkedin_recommendations.map((rec, idx) => (
        <motion.div key={idx} className="bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md outline-1 outline-gray-700 transition-transform duration-300 hover:scale-102 p-6 text-start flex"
